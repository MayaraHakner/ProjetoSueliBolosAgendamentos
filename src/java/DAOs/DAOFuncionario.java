...
private List<Funcionario> lista = new ArrayList<>();    public DAOFuncionario(){
    ...
    public List<Funcionario> listInOrderNome() {
        return em.createQuery("SELECT e FROM Funcionario e ORDER BY e.nome").getResultList();
    }
...
public static void main(String[] args) {
        ...
        for (Funcionario produto : listaFuncionario) {
            System.out.println(produto.getIdFuncionario()+"-"+produto.getNomeFuncionario());
        }
    }}