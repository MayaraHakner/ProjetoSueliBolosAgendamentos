...
<%
    ...
    List<Status> status = dao.listInOrderId();
    Status s = new Status();
%>
<!DOCTYPE html>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro Funcionário</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form method="post" action="${pageContext.request.contextPath}/Funcionario">
                                            <div class="form-group">
                                                <label >Código</label>
                                                <% DAOs.DAOFuncionario dAOFuncionario = new DAOs.DAOFuncionario();%>
                                                <input name="idFuncionario"class="form-control" placeholder="" value="<%=dAOFuncionario.autoIdFuncionario() %>" readonly="">
                                            </div>
                                            <div class="form-group">
                                                <label > Nome </label>
                                                <input name="nomeFuncionario" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label > Data de Nascimento </label>
                                                <input name="dataFuncionario" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label > Telefone </label>
                                                <input name="telefoneFuncionario" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label > Endereço </label>
                                                <input name="enderecoFuncionario" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label > Status </label>
                                                <select class="form-control" name="status">
                                                    <%
                                                        for (Status p : status) {
                                                    %>
                                                    <option value="<%=p.getIdStatus()%>"> <%= p.getNomeStatus() %> </option>
                                                    <%}%>
                                                </select>    
                                            </div>
                                            <!-- <div class="form-group">
