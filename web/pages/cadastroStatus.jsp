    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro Status</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                    ...
                                    <div class="col-lg-6">
                                        <form method="post" action="${pageContext.request.contextPath}/Status">
                                            <div class="form-group">
                                                ...
                                                <input name="idStatus"class="form-control" placeholder="" value="<%=dAOStatus.autoIdStatus()%>" readonly="">
                                            </div>
                                            <div class="form-group">
                                                <label > Status </label>
                                                <input name="nomeStatus" class="form-control" placeholder="">
                                            </div>
