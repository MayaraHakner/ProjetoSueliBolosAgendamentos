...
<%
    ...
    List<Produto> produto = dao.listInOrderId();
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro Preço Produto</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form method="post" action="${pageContext.request.contextPath}/PrecoProduto">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="produto">
                                                    ...
                                                    %>
                                                    <option value="<%=p.getIdProduto()%>"> <%= p.getNomeProduto()%> </option>
                                                    <%}%>
                                                </select>    
                                            ...
                                            <div class="form-group">
                                                <label > Preço </label>
                                                <input name="preco" class="form-control" placeholder="">
                                            </div>
