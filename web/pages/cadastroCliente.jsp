                                    ...
                                    <div class="col-lg-6">
                                        <form method="post" action="${pageContext.request.contextPath}/Cliente">
                                            <div class="form-group">
                                                <label >Código</label>
                                                <input name="idCliente"class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label > Nome </label>
                                                <input name="nomeCliente" class="form-control" placeholder="">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label > Endereço </label>
                                                <input name="enderecoCliente" class="form-control" placeholder="">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label > Observação </label>
                                                <input name="observacaoCliente" class="form-control" placeholder="">
                                            </div>
